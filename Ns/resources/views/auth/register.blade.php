        ...
        <div class="relative bg-white border border-gray-300 shadow-lg rounded-lg px-12 py-1 w-[28rem]">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-2">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" class="px-3 py-2 border-2 border-gray-300 rounded-md rounded-md w-full"
                        value="{{ old('name') }}">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" class="px-3 py-2 border-2 border-gray-300 rounded-md rounded-md w-full"
                        value="{{ old('email') }}">
                    @error('email')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" class="px-3 py-2 border-2 border-gray-300 rounded-md rounded-md w-full">
